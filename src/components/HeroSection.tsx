...
const HeroSection = () => {
    return (
        <motion.section id="about" className='hero t-10 pb-10 flex flex-col gap-4 p-4' initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, ease: "easeOut" }}>
            <div className="flex justify-start w-max gap-6">
                <p className="tag w-max text-lg">Full Stack Software Engineer</p>
                <p className="tag w-max text-lg">Frontend Developer</p>
            </div>
